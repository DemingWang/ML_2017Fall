...
def main():
    ...
    print('RMSE_train Univariate: {:,.2f}'.format( E_rms_train_uni))
    print('J_train Univariate: {:,.2f}'.format( J_train_uni))

    # Print cost and RMSE on test data.
    print("\n")
    print('RMSE_test Univariate: {:,.2f}'.format( E_rms_test_uni))
    print('J_test Univariate: {:,.2f}'.format( J_test_uni))
